...
<div class="container">
  ...
  <form action="includes/controllers/signup.controller.php" method="POST" class="signup-form" novalidate>
    ...
    <div class="form-group">
      ...
      <div class="error-msg" id="username_error"></div>
    </div>
    ...
    <div class="form-group">
      ...
      <input type="password" name="password" id="password" required minlength="8">
            <ul class="password-requirements hidden" id="password-reqs">
    ...
    <div class="form-group">
      ...
      <div class="error-msg" id="referral_error"></div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="error-msg" id="account_type_error"></div>
    </div>

    <div class="form-group">
      <!-- Google reCAPTCHA -->
      <div class="g-recaptcha" data-sitekey="6Lc4X2IrAAAAAKFO2Kmcql_beV0robdSCGRE0bPM"></div>
      <div class="error-msg" id="recaptcha_error"></div>
    </div>
